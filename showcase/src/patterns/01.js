...
const withClapAnimation = (WrappedComponent) => {
    ...
    componentDidMount() {
      ...
      const newAnimationTimeline = this.animationTimeline.add([scaleButton, triangleBurst, circleBurst, countTotalAnimation, countAnimation])
...
const MediumClap = ({ animationTimeline }) => {
	...
	return (
		<button id="clap" className={styles.clap} onClick={handleClapClick}>
			...
			<ClapCount id="clapCount" count={count} />
			<CountTotal id="clapCountTotal" countTotal={countTotal} />
		</button>
	);
};
